...
def analyse_cloud_cover(image, current_date_and_time):
    ...
    cloud_threshold = 50  # You may adjust this threshold as needed
    ...
    # Display the result
    filename = f"{current_date_and_time}_SkyPercentage_{sky_percentage:.2f}.jpg"

    # Save the image with a different file extension (e.g., .png)
